...
In this policy, the terms "AI" and "artificial intelligence" are used to refer primarily to generative AI or hybrid AI systems that incorporate machine learning and large language models, and that produce primarily probabilistic outputs. This includes commonly used tools such as ChatGPT, GitHub Copilot, Claude, Gemini, and similar systems.
