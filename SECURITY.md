...
Protecting the privacy and security of PrivacySafe users is our top priority. If you identify any problems with PrivacySafe software or infrastructure — such as security issues, privacy risks, exposed data, or software vulnerabilities — we encourage you to report these issues to us. We provide bug bounty rewards for responsible disclosures from members of the global "white hat" hacking and Open Source Intelligence (OSINT) communities.

We are dedicated to releasing PrivacySafe products built upon ethical Free and Open-Source Software (FOSS). Responsible disclosure practices by researchers will result in transparent and honest publishing and [acknowledgement](https://privacysafe.tools/security/thanks.html) after risks to the public, our users, and our team have been resolved or mitigated against.
...
* Infrastructure owned, operated, or maintained by PrivacySafe. This includes websites and public-facing applications.
...
* Social engineering of PrivacySafe users, PrivacySafe team members, and FOSS contributors;
* Services, applications, and mix networks run by volunteers (e.g., Tor hidden services);
* Assets, equipment, and systems not owned by PrivacySafe; and
* [Commonplace Reports](#commonplace-reports) as described in this policy.

If you come across vulnerabilities in systems that do not belong to PrivacySafe, we urge you to report them to the relevant owner, vendor, or appropriate authority. It is crucial to refrain from engaging in activities such as Denial-of-Service (DoS), actively exploiting networks, or making any physical or electronic attempts against property and/or data centers.
...
PrivacySafe follows a **90 day disclosure timeline** as described in this policy. To help us address and resolve the issue, please provide as much detail as possible.
...
* **No social engineering:** Bugs that require social engineering to exploit (e.g., tricking someone into clicking a link) may qualify, but please do not actually attempt to socially engineer another user, PrivacySafe team member, FOSS contributors, etc. during your testing. Providing a clear explanation of how social engineering could be used in conjunction with an identified vulnerability is sufficient.
...
* Attacks dependent upon social engineering of Panquake users, PrivacySafe team members, or FOSS contributors
